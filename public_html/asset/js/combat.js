...
const soundBattleOne = document.getElementById('soundBattleOne');
const soundBattleTwo = document.getElementById('soundBattleTwo');
const soundVictory = document.getElementById('soundVictory');
const returnHome = document.getElementById('returnHome');
const soundhealing = document.getElementById('soundhealing');
